...
namespace ERP_API.Application.Services.Interface
{
    public interface ICustomerService
    {
        ...
        Task<IEnumerable<CustomerDto>> GetAllByFilter(int? CustomerTypeId = null, string? customerCode = null, string? Name = null, string? Tel = null); Task<CustomerDto> CreateAsync(CreateCustomerDto createCustomerDto);
